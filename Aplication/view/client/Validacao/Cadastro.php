            ...
            <div class="card auth-content mb-0">
                <div class="card-body py-5">
                    <div class="text-center mb-4">
                          <img src="../img/logoG20_BTC_original_v1.png" class="rounded " alt="LogoG20">
                    </div>
                    ...
                    <form id="login-form" action="" method="post">
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" type="text" autocomplete="off" name="nome"><label>Nome</label></div>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" type="tel" name="telefone" autocomplete="off" im-insert="true"><label>Telefone</label></div>
                            <small class="form-text text-muted">Formato +55 (DD) (9999-9999)</small>
                        </div>
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" type="text" autocomplete="off" name="nomeUsuario"><label>Nome de Usuario</label></div>
                        </div>
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" type="password" autocomplete="off" name="password"><label>Senha</label></div>
                        </div>
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" type="password"  autocomplete="off" name="confimPassword"><label>Confirme sua senha</label></div>
                        </div>
                        <div class="mb-4">
                            <div class="md-form mb-0"><input class="md-form-control" type="text" autocomplete="off" name="idIndicador"><label>Id do indicador</label></div>
                        </div>
                        <div>
                        
                        </div>
                        <input class="btn btn-success btn-rounded btn-block" type="submit" name="" value="Registrar">
                        <input class="btn btn-danger btn-rounded btn-block" type="submit" name="" value="Login">
                    </form>
