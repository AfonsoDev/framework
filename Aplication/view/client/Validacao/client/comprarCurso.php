        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                                    ...
                                    <div class="py-4 card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <h1 class="mb-2">0,0000000 BTC</h1>
                                                <div class="mb-0">
                                                    <form method="post" name="frm_reservabitcoin" class="">
                                                        <input class="btn btn-info btn-rounded btn-sm mt-0" name="" type="submit" value="Enviar">
                                                    </form>
                                                </div>
                                            </div>
                ...
                <div class="row">
                            <div class="col-md-6 col-lg">
                                <div class="flex-fill card rounded-0">
                                    <div class="py-4 card-body rounded-0">
                                                        ...
                                                        <div class="py-4 card-body">
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body text-center">
                                                                    ...
                                                                    <form method="post" name="frm_comprarcurso1" class="">
                                                                        <input class="btn btn-success btn-rounded btn-lg mt-0" type="submit" value="Comprar" name="">
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="py-4 card-body">
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body text-center">
                                                                    ...
                                                                    <div class="mb-0">Texto</div>
                                                                    <h5 class="mb-1">Numero</h5>
                                                                    <form method="post" name="frm_comprarcurso2" class="">
                                                                        <input class="btn btn-success btn-rounded btn-lg mt-0" type="submit" value="Comprar" name="">
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="py-4 card-body">
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body text-center">
                                                                    ...
                                                                    <div class="mb-0">Texto</div>
                                                                    <h5 class="mb-1">Numero</h5>
                                                                    <form method="post" name="frm_comprarcurso3" class="">
                                                                        <input class="btn btn-success btn-rounded btn-lg mt-0" type="submit" value="Comprar" name="">
                                                                    </form>
                                                                </div>
                                                            </div>
