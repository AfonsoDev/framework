            ...
            <div class="content-area">
                ...
                <div class="container-fluid">
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6 col-xl">
                                 <div class="flex-fill card rounded-0">
                                     <div class="py-2 mb-1 mt-1 pl-3 pr-4 card-body">
                                        <div class="media">
                                            <div class="d-inline-block mt-2 mr-3"></div>
                                            <div class="media-body">
                                            <h4 class="mb-1">Saldo Reserva</h4>
                                            <h3 class="mb-1">0,0000000 BTC</h3><i class="ft-database data-widget-icon"></i>
                                                <p class="py-0 m-0"><i class="sidebar-item-icon ft-check"></i> Status recompra automática</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="flex-fill card rounded-0">
                                     <div class="py-4 card-body">
                                        <div class="media">
                                            ...
                                            <h3 class="mb-1">000 BTC</h3><i class="ft-user data-widget-icon"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    ...
                                                    <div class="mb-2 text-center">
                                                        <div>
                                                            <div id="clipboard_element">http://www.site.com.br/seuid</div>
                                                            <button class="btn btn-primary btn-rounded btn-block mt-3" data-clipboard="true" data-clipboard-target="#clipboard_element" type="button">Copiar</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="d-flex col-lg-12">
                                <div class="flex-fill w-100 card rounded-0">
                                    <div class="card-header">
                                        <h4 class="mb-0 card-title"><i class="sidebar-item-icon ft-refresh-cw"></i> Últimos recebimentos</h4>
                                    </div>
                                    <div class="card-body">
