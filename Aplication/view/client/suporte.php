    ...
    <div class="page-wrapper">
        <div class="content-wrapper">
            ...
            <div class="page-sidebar custom-scroll text-dark" id="sidebar">
                <div class="sidebar-header mb-0 p-0 pt-2"><a class="sidebar-brand" href="index.html"><img src="img/logo_G20_BTC_250x100_v1_branco.png" class="rounded" alt="LogoG20"></a><a class="sidebar-brand-mini" href="index.html"></a><span class="sidebar-points"></span></div>
                <ul class="sidebar-menu metismenu">
                    ...
                    <li><a href="#"><i class="sidebar-item-icon ft-user"></i><span class="nav-label"><p>Perfil</p></span></a></li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="row mt-2 ml-2">
                                        <div class="col-11"> 
                                           <h4><i class="ti-headphone-alt"></i> Tickets de suportes</h4>     
                                        
                                        </div>
                                        <div class="col-1"> 
                                                <button data-toggle="modal" data-target="#modal" class="btn btn-lg btn-info btn-rounded">Abrir</button>
                                        </div>
                                    </div>
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" 
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <h4 class="modal-title h4 text-center" id="exampleLargeModalLabel">Assunto do Tickets</h4><button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"></span>X</button></div>
